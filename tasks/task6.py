...
from tasks.task3 import DocumentProcessor
from tasks.task4 import EmbeddingClient
from tasks.task5 import ChromaCollectionCreator
...
if __name__ == "__main__":
    ...
    with screen.container():
        ...
        with st.form("Load Data to Chroma"):
            ...
            topic_input=st.text_input(label='Topic for Generative Quiz',placeholder='Énter the topic of the document',label_visibility='hidden')
            st.write("Number of Questions")
            n_ques=st.slider(label='Number of Questions',min_value=1,max_value=10,label_visibility='hidden')
            document = None
