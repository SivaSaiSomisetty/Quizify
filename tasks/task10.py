...
from tasks.task8 import QuizGenerator
from tasks.task9 import QuizManager
    ...
    if 'question_bank' not in st.session_state or len(st.session_state['question_bank']) == 0:
        ...
        with screen.container():
            ...
            with st.form("Load Data to Chroma"):
                ...
                ##### YOUR CODE HERE #####
                topic_input=st.text_input("Topic for the Quiz",placeholder='Enter topic of the document')
